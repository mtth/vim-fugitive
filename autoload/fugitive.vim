...
function! fugitive#BufReadStatus() abort
  ...
  try
    ...
    call s:Map('n', 'S', ":exe <SID>EchoExec('add', '-A')<CR>", '<silent>')
...
function! fugitive#MapJumps(...) abort
  if !&modifiable
    ...
    call s:Map('n', 'ca', ':<C-U>Git commit --quiet --amend<CR>', '<silent>')
    call s:Map('n', 'cc', ':<C-U>Git commit --quiet <CR>', '<silent>')
    call s:Map('n', 'ce', ':<C-U>Git commit --quiet --amend --no-edit<CR>', '<silent>')
    call s:Map('n', 'cw', ':<C-U>Git commit --quiet --amend --only<CR>', '<silent>')
